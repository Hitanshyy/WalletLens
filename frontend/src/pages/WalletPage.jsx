...
export default function WalletPage() {
      ...
      try {
        ...
        if (err.response) {
          ...
          setError({
            ...
            detail: 'Could not connect to the WalletLens API. Please try again later.',
          })
        }
      } finally {
        setLoading(false)
  ...
  if (error) {
    return (
      ...
      >
        <div
          className="w-full max-w-lg rounded-2xl p-6 animate-fade-up"
  ...
  return <Dashboard data={data} onReset={() => navigate('/')} />
}